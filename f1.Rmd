...
```{r}
#dataframe with fastest lap speed driver id and race id, this makes it earsier to add fastest lap to dataframes 
...
driver_results_df <- na.omit(driver_results_df)                                          #remove NA if any
...
ggplot(aes(x= fastestLapSpeed, y = Driver)) +
  ...
  ggtitle("Max speed per lap by Driver when they won the race (2010-2021)")+
  theme_minimal() +
  labs(
    fill = "nationality", 
    color = "nationality",
